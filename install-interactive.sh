...
# Interactive Hyprland Keyboard Hotswap Installer
...
main() {
    print_msg "\n╔════════════════════════════════════════════════╗" "$BLUE"
    print_msg "║  INTERACTIVE KEYBOARD HOTSWAP INSTALLER       ║" "$BLUE"
    print_msg "╚════════════════════════════════════════════════╝" "$BLUE"

    check_sudo

    print_msg "\nThis installer will:" "$YELLOW"
    print_msg "  1. Detect your external keyboard" "$NC"
    print_msg "  2. Let you choose which keys act as Super/Alt/Ctrl" "$NC"
    print_msg "  3. Set up automatic switching when you plug/unplug" "$NC"
    print_msg "  4. Configure different mappings for laptop vs external" "$NC"
    ...
    print_msg "\nTo reconfigure: Run this installer again" "$BLUE"
    print_msg "To uninstall: Run ./uninstall.sh" "$BLUE"
}
